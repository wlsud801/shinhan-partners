    ...
    return (
        <div className="bg-bl400 min-h-[100dvh] relative">
            ...
            <div className="text-center w-3/4 min-w-[285px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="550">
                    <p className="blue-bg-text-box">나의 예상 소득</p>
                    <Image src={coin} alt="코인 시계" width={295} height={168} className="m-auto my-7" />
                    ...
                    <p className="text-sm text-bl300 my-4">예상되는 계약 금액은 {calc(id)[2]}만원이에요</p>
