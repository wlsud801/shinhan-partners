            ...
            >
                <Slider {...settings} className="mt-5">
                    <div className="w-[240px] ml-5">
                        <div className="p-5 w-[220px] bg-white rounded-3xl border border-bl400 ">
                        ...
                        content={
                            <div className="p-5 w-[220px]">
                                ...
                                <p className="text-sm">
                                    학생 때 부모님이 들어놓은 보험이 있는데 매달 20만 원씩 나가고 있어요. 그래서 보험
                                    리모델링을 알아봤는데 남을 못 믿어서 그냥 제가 해보기로 했어요! 휴.. 진작할 걸
                                    그랬어요!! 쓸데없는 보장 다 없애고 보험료도 확 줄고 부수익까지 얻으니까 본업보다
                                    여기에 더 관심이 가더라고요? 원래 제 보험 점검만 하려고 했는데 부모님 보험도 한 번
                                    점검해 보려고요.
                                </p>
                            </div>
                        }
