...
interface ModalProps {
    ...
    setPersonalChecked: React.Dispatch<React.SetStateAction<boolean>>;
}

function PermModal({ open, setIsOpen, personalChecked, setPersonalChecked }: ModalProps) {
    const handleAgree = () => {
        setPersonalChecked(true);
        setIsOpen(false);
    };
    return (
        <Modal isOpen={open} ariaHideApp={false} className="absolute w-full h-full bottom-0 left-1/2 overflow-y-auto">
            <div className="p-7 bg-white min-h-[70vh]">
                <button className="float-right">
                    <Image src={close} alt="닫기" width={17} height={17} onClick={() => setIsOpen(false)} />
                </button>
                ...
                <p className="text-sm">
                    신한 파트너스(이하 &apos;회사&apos;라 함)는 개인정보 보호법 및 관련 법령을 준수하여 고객의
                    개인정보를 보호합니다. 본 약관은 회사가 고객의 개인정보를 수집, 이용하는 방법 및 절차에 대한 안내를
                    목적으로 합니다.
                </p>
                ...
                <p className="text-sm">
                    ...
                    <br />
                    - 주소 및 기타 연락처 정보 <br />
                    - 금융정보: 은행 계좌 정보, 카드 정보 등 <br />- 서비스 이용 기록: 접속 로그, 쿠키, IP 주소, 이용
                    기록 등
                </p>
                ...
                <p className="text-sm">
                    ...
                    - 고객 문의 및 불만 처리 맞춤형 서비스 제공 및 마케팅 자료 제공 <br />- 법적 요구 사항 및 규정 준수
                </p>
                <h3 className="text-sm font-bold mt-3 mb-1">제4조 (개인정보의 보유 및 이용 기간)</h3>
                <p className="text-sm">
                    회사는 개인정보를 수집 목적 달성 후에는 관련 법령에 따라 적법한 절차에 의해 개인정보를 파기합니다.
                    단, 다음의 경우에는 개인정보를 보유합니다: <br />
                    - 법령에 의해 보존이 필요한 경우 (예: 거래 기록, 계약서 등) <br />- 고객의 요청에 의해 보존이 필요한
                    경우
                </p>
                ...
                <p className="text-sm">
                    고객은 언제든지 본인의 개인정보에 대한 열람, 정정, 삭제, 처리 정지를 요구할 수 있습니다. 이러한
                    요구는 고객센터를 통해 접수되며, 회사는 관련 법령에 따라 신속하게 처리합니다.
                </p>
                ...
                <p className="text-sm">
                    회사는 본 약관을 변경할 수 있으며, 변경된 내용은 회사의 웹사이트에 공지하여 고객에게 알립니다. 약관
                    변경 후 서비스 이용 시, 고객은 변경된 약관에 동의한 것으로 간주됩니다.
                </p>
                <h3 className="text-sm font-bold mt-3 mb-1">제10조 (기타) </h3>
                <p className="text-sm">
                    본 약관에 명시되지 않은 사항은 관련 법령 및 회사의 개인정보 처리 방침에 따릅니다.
                </p>
                <hr className="my-4" />
                <input
                    type="button"
                    ...
                    onClick={() => handleAgree()}
                />
                <button className="text-sm" onClick={() => handleAgree()}>개인정보 수집에 동의합니다.</button>
            </div>
        </Modal>
    );
}
